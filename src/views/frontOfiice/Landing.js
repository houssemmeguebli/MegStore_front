              ...
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  ...
                  <p className="mt-4 text-lg text-blueGray-200">
                    Explore a wide range of products and categories at MegStore. From the latest electronics to stylish
                    fashion items, we've got something for everyone.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                ...
                <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
                  At MegStore, we offer a curated selection of high-quality products across various categories, ensuring
                  that you find exactly what you need. Our dedicated customer support team is here to assist you every
                  step of the way.
                </p>
                <p className="text-lg font-light leading-relaxed mt-0 mb-4 text-blueGray-600">
                  Explore our collection, enjoy seamless shopping experiences, and take advantage of our exclusive deals
                  and promotions.
                </p>
